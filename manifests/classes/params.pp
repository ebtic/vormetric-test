class vormetric_test::params {
  ...
  if $appcara::params::site {
    ...
    if $site_extsvc_option {
      $site_vormetric_option = $site_extsvc_option["vormetric_test"]
  ...
  if $appcara::params::account{
    ...
    notify {"vormetric_test_acct_extsvc_option ${acct_extsvc_option}":}
    if $acct_extsvc_option {
      $acct_vormetric_option = $acct_extsvc_option['vormetric_test']
  ...
  if $appcara::params::server {
    ...
    notify {"vormetric_test_svr_extsvc_option ${svr_extsvc_option}":}
    if $svr_extsvc_option {
      $svr_vormetric_option = $svr_extsvc_option['vormetric_test']
